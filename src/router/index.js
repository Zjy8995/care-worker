...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'sickbed-manage',
        component: () => import('@/views/admin-worker/sickbed-manage/index.vue')
      },
      {
        path: 'sickroom-manage',
        component: () => import('@/views/admin-worker/sickroom-manage/index.vue')
      },
      {
        path: 'nursing-manage',
        component: () => import('@/views/admin-worker/nursing-manage/index.vue')
      },
      {
        path: 'leave',
