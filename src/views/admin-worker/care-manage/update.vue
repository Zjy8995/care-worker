        ...
        <el-form :model="careForm" label-width="120px">
            <el-form-item label="证件照">
                <el-upload
                    ...
                    <el-image v-if="careForm.avatar" style="width: 100px; height: 100px" src="https://images.weserv.nl/?url=https://img2.woyaogexing.com/2022/04/19/bd415ba23fd041e28cf4add545aa7eb5!400x400.jpeg" fit="fill" />
           ...
           <el-row>
            ...
            <el-form-item>
                <el-button type="primary" @click="router.push('/admin/care-manage')">返回</el-button>
