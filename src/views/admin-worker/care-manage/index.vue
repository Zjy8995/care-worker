<template>
    <el-card class="care-manage__card">
        <ITable
            ...
            <template #header>
                <div class="care-manage__card-title">
                    护工管理
                </div>
            </template>
            <template #edit="scope">
                <el-button type="primary" size="small" :icon="Edit" circle @click="router.push({ path: '/admin/care-manage-update', query: { id: scope.row.id } })" />
                <el-popconfirm
